...
import com.minisdk.glide.manager.ActivityFragmentLifecycle;
 ...
 *
 * @see com.minisdk.glide.manager.RequestManagerFragment
 * @see com.minisdk.glide.manager.RequestManagerRetriever
 * @see RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
  private static final String TAG = "SupportRMFragment";
  private final com.minisdk.glide.manager.ActivityFragmentLifecycle lifecycle;
  private final com.minisdk.glide.manager.RequestManagerTreeNode requestManagerTreeNode =
  ...
  public SupportRequestManagerFragment() {
    this(new com.minisdk.glide.manager.ActivityFragmentLifecycle());
  }

  @VisibleForTesting
  @SuppressLint("ValidFragment")
  public SupportRequestManagerFragment(@NonNull com.minisdk.glide.manager.ActivityFragmentLifecycle lifecycle) {
  ...
  @NonNull
  com.minisdk.glide.manager.ActivityFragmentLifecycle getGlideLifecycle() {
    return lifecycle;
  }
  ...
  /**
   * Returns the {@link com.minisdk.glide.manager.RequestManagerTreeNode} that provides tree traversal methods relative
   * to the
   * associated {@link RequestManager}.
   */
  @NonNull
  public com.minisdk.glide.manager.RequestManagerTreeNode getRequestManagerTreeNode() {
