...
import com.minisdk.glide.manager.ApplicationLifecycle;
import com.minisdk.glide.manager.EmptyRequestManagerTreeNode;
import com.minisdk.glide.manager.Lifecycle;
import com.minisdk.glide.manager.RequestManagerFragment;
import com.minisdk.glide.manager.RequestManagerTreeNode;
import com.minisdk.glide.manager.SupportRequestManagerFragment;
...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "com.minisdk.glide.manager";
  ...
  @VisibleForTesting
  final Map<android.app.FragmentManager, com.minisdk.glide.manager.RequestManagerFragment> pendingRequestManagerFragments =
      new HashMap<>();
      ...
      synchronized (this) {
        if (applicationManager == null) {
          ...
          applicationManager =
              factory.build(
                  glide,
                  new com.minisdk.glide.manager.ApplicationLifecycle(),
  ...
  @Deprecated
  @NonNull
  com.minisdk.glide.manager.RequestManagerFragment getRequestManagerFragment(Activity activity) {
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  private com.minisdk.glide.manager.RequestManagerFragment getRequestManagerFragment(
      @NonNull final android.app.FragmentManager fm,
      @Nullable android.app.Fragment parentHint,
      boolean isParentVisible) {
    com.minisdk.glide.manager.RequestManagerFragment current = (com.minisdk.glide.manager.RequestManagerFragment) fm.findFragmentByTag(FRAGMENT_TAG);
    if (current == null) {
      current = pendingRequestManagerFragments.get(fm);
      if (current == null) {
        current = new com.minisdk.glide.manager.RequestManagerFragment();
  ...
  public interface RequestManagerFactory {
    ...
    RequestManager build(
            @NonNull Glide glide,
            @NonNull com.minisdk.glide.manager.Lifecycle lifecycle,
            @NonNull com.minisdk.glide.manager.RequestManagerTreeNode requestManagerTreeNode,
            @NonNull Context context);
  }
