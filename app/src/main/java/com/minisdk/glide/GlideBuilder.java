...
import com.minisdk.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.minisdk.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.minisdk.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.minisdk.glide.load.engine.cache.DiskCache;
import com.minisdk.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.minisdk.glide.load.engine.cache.LruResourceCache;
import com.minisdk.glide.load.engine.cache.MemoryCache;
import com.minisdk.glide.load.engine.cache.MemorySizeCalculator;
import com.minisdk.glide.load.engine.executor.GlideExecutor;
import com.minisdk.glide.manager.ConnectivityMonitorFactory;
import com.minisdk.glide.manager.DefaultConnectivityMonitorFactory;
import com.minisdk.glide.manager.RequestManagerRetriever;
import com.minisdk.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
   ...
   * {@link com.minisdk.glide.load.engine.Resource}s that are not currently in use.
   *
   ...
   * com.minisdk.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.minisdk.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link com.minisdk.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.minisdk.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.minisdk.glide.load.resource.gif.GifDrawable} or
   ...
   * to use to notify {@link com.minisdk.glide.RequestManager} of connectivity events.
   * If not set {@link com.minisdk.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * {@link com.minisdk.glide.load.engine.GlideException#setOrigin(Exception)} for failed requests.
   *
  ...
  @NonNull
  com.minisdk.glide.Glide build(@NonNull Context context) {
