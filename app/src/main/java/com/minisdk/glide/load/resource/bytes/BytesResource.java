package com.minisdk.glide.load.resource.bytes;
...
public class BytesResource implements Resource<byte[]> {
   ...
   * @see com.minisdk.glide.load.ResourceEncoder
   * @see com.minisdk.glide.load.resource.transcode.ResourceTranscoder
   * @see com.minisdk.glide.request.SingleRequest#onResourceReady
   */
  @NonNull
  @Override
