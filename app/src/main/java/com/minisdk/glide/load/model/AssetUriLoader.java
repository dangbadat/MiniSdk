...
import com.minisdk.glide.load.data.FileDescriptorAssetPathFetcher;
import com.minisdk.glide.load.data.StreamAssetPathFetcher;
import com.minisdk.glide.load.model.ModelLoader;
import com.minisdk.glide.load.model.ModelLoaderFactory;
import com.minisdk.glide.signature.ObjectKey;
 ...
 */
public class AssetUriLoader<Data> implements com.minisdk.glide.load.model.ModelLoader<Uri, Data> {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>,
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiFactory) {
