...
public class DecodePath<DataType, ResourceType, Transcode> {
  ...
  public com.minisdk.glide.load.engine.Resource<Transcode> decode(DataRewinder<DataType> rewinder, int width, int height,
                                                                   @NonNull Options options, DecodeCallback<ResourceType> callback) throws GlideException {
    com.minisdk.glide.load.engine.Resource<ResourceType> decoded = decodeResource(rewinder, width, height, options);
    com.minisdk.glide.load.engine.Resource<ResourceType> transformed = callback.onResourceDecoded(decoded);
    return transcoder.transcode(transformed, options);
  }

  @NonNull
  private com.minisdk.glide.load.engine.Resource<ResourceType> decodeResource(DataRewinder<DataType> rewinder, int width,
  ...
  @NonNull
  private com.minisdk.glide.load.engine.Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> rewinder, int width,
                                                                                       int height, @NonNull Options options, List<Throwable> exceptions) throws GlideException {
    com.minisdk.glide.load.engine.Resource<ResourceType> result = null;
  ...
  interface DecodeCallback<ResourceType> {
    @NonNull
    com.minisdk.glide.load.engine.Resource<ResourceType> onResourceDecoded(@NonNull Resource<ResourceType> resource);
  }
}
