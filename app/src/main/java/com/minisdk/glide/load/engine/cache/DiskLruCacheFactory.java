...
import com.minisdk.glide.load.engine.cache.DiskLruCacheWrapper;

import java.io.File;

/**
 * Creates an {@link com.minisdk.glide.disklrucache.DiskLruCache} based disk cache in the specified
...
public class DiskLruCacheFactory implements com.minisdk.glide.load.engine.cache.DiskCache.Factory {
