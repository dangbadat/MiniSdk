...
import com.minisdk.glide.load.data.DataFetcher.DataCallback;
 ...
 * com.minisdk.glide.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
class MultiModelLoader<Model, Data> implements com.minisdk.glide.load.model.ModelLoader<Model, Data> {

  private final List<com.minisdk.glide.load.model.ModelLoader<Model, Data>> modelLoaders;
  private final Pool<List<Throwable>> exceptionListPool;

  MultiModelLoader(@NonNull List<com.minisdk.glide.load.model.ModelLoader<Model, Data>> modelLoaders,
  ...
  public LoadData<Data> buildLoadData(@NonNull Model model, int width, int height,
    ...
    for (int i = 0; i < size; i++) {
      com.minisdk.glide.load.model.ModelLoader<Model, Data> modelLoader = modelLoaders.get(i);
