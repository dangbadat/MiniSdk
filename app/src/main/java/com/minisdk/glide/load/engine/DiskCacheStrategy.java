...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.minisdk.glide.load.data.DataFetcher} and the
   * {@link com.minisdk.glide.load.EncodeStrategy} of the
   * {@link com.minisdk.glide.load.ResourceEncoder} (if an
   * {@link com.minisdk.glide.load.ResourceEncoder} is available).
   */
   ...
   * com.minisdk.glide.load.ResourceEncoder} will use to encode the resource.
   */
