...
import com.minisdk.glide.load.data.HttpUrlFetcher;
import com.minisdk.glide.load.model.GlideUrl;
import com.minisdk.glide.load.model.ModelCache;
...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT = Option.memory(
      "com.minisdk.glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
