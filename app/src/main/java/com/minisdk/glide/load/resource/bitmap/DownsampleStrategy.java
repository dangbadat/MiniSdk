 ...
 * differ depending on the {@link com.minisdk.glide.load.ResourceDecoder} using the strategy and
 ...
 * {@link com.minisdk.glide.load.Transformation} either instead or in addition to a
 * {@code DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and
 * {@link com.minisdk.glide.load.ResourceDecoder}s are listed below, but the list is not
...
public abstract class DownsampleStrategy {
   ...
   * {@link #CENTER_INSIDE}.
   *
   * <p>On pre-KitKat devices, {@link com.minisdk.glide.load.resource.bitmap.Downsampler} treats this as equivalent to {@link #AT_MOST}
  ...
  public static final Option<DownsampleStrategy> OPTION =
      Option.memory(
          "com.minisdk.glide.load.resource.bitmap.Downsampler.DownsampleStrategy", DEFAULT);
