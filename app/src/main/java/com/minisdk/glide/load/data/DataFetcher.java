package com.minisdk.glide.load.data;
 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.minisdk.glide.load.model.ModelLoader}. {@link
 * #loadData(Priority, com.minisdk.glide.load.data.DataFetcher.DataCallback)}
 ...
 * com.minisdk.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * com.minisdk.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.minisdk.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.minisdk.glide.load.DataSource} this fetcher will return data from.
   */
  @NonNull
