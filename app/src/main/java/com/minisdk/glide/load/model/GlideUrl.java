...
import com.minisdk.glide.load.model.Headers;
 ...
 *
 * <p> This class can also optionally wrap {@link com.minisdk.glide.load.model.Headers} for
 * convenience. </p>
 */
public class GlideUrl implements Key {
  private static final String ALLOWED_URI_CHARS = "@#&=*+-_.,:!?()/~'%;$";
  private final com.minisdk.glide.load.model.Headers headers;
  ...
  public GlideUrl(URL url) {
    this(url, com.minisdk.glide.load.model.Headers.DEFAULT);
  }
  ...
  public GlideUrl(URL url, com.minisdk.glide.load.model.Headers headers) {
