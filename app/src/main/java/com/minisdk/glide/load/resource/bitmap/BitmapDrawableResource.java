...
import com.minisdk.glide.load.engine.Initializable;
import com.minisdk.glide.load.engine.bitmap_recycle.BitmapPool;
import com.minisdk.glide.load.resource.drawable.DrawableResource;
import com.minisdk.glide.util.Util;

/**
 * A {@link com.minisdk.glide.load.engine.Resource} that wraps an
 * {@link BitmapDrawable}
 *
