package com.minisdk.glide.load;
 ...
 */
public class MultiTransformation<T> implements com.minisdk.glide.load.Transformation<T> {
  private final Collection<? extends com.minisdk.glide.load.Transformation<T>> transformations;

  @SafeVarargs
  @SuppressWarnings("varargs")
  public MultiTransformation(@NonNull com.minisdk.glide.load.Transformation<T>... transformations) {
  ...
  public MultiTransformation(@NonNull Collection<? extends com.minisdk.glide.load.Transformation<T>> transformationList) {
  ...
  public Resource<T> transform(
    ...
    for (com.minisdk.glide.load.Transformation<T> transformation : transformations) {
