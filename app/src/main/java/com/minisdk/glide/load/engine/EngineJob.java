...
import com.minisdk.glide.load.engine.DecodeJob;
import com.minisdk.glide.load.engine.EngineJobListener;
import com.minisdk.glide.load.engine.EngineResource;
import com.minisdk.glide.load.engine.EngineResource.ResourceListener;
import com.minisdk.glide.load.engine.Resource;
import com.minisdk.glide.load.engine.executor.GlideExecutor;
import com.minisdk.glide.request.ResourceCallback;
 ...
 */
class EngineJob<R> implements com.minisdk.glide.load.engine.DecodeJob.Callback<R>,
    Poolable {
  ...
  private com.minisdk.glide.load.engine.Resource<?> resource;
  ...
  private com.minisdk.glide.load.engine.DecodeJob<R> decodeJob;
  ...
  public synchronized void start(com.minisdk.glide.load.engine.DecodeJob<R> decodeJob) {
  ...
  @Override
  public void onResourceReady(com.minisdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    synchronized (this) {
  ...
  @Override
  public void reschedule(com.minisdk.glide.load.engine.DecodeJob<?> job) {
