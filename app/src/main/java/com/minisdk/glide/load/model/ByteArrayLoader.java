 ...
 */
public class ByteArrayLoader<Data> implements com.minisdk.glide.load.model.ModelLoader<byte[], Data> {
  ...
  /**
   * Factory for {@link com.minisdk.glide.load.model.ByteArrayLoader} and
   * {@link ByteBuffer}.
   */
  public static class ByteBufferFactory implements ModelLoaderFactory<byte[], ByteBuffer> {
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<byte[], ByteBuffer> build(@NonNull MultiModelLoaderFactory multiFactory) {
