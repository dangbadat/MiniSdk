package com.minisdk.glide.load.engine.bitmap_recycle;
...
import com.minisdk.glide.load.engine.bitmap_recycle.BaseKeyPool;
import com.minisdk.glide.load.engine.bitmap_recycle.GroupedLinkedMap;
import com.minisdk.glide.load.engine.bitmap_recycle.LruPoolStrategy;
import com.minisdk.glide.load.engine.bitmap_recycle.Poolable;
...
public class SizeConfigStrategy implements com.minisdk.glide.load.engine.bitmap_recycle.LruPoolStrategy {
  ...
  private final com.minisdk.glide.load.engine.bitmap_recycle.GroupedLinkedMap<Key, Bitmap> groupedMap = new com.minisdk.glide.load.engine.bitmap_recycle.GroupedLinkedMap<>();
  ...
  @VisibleForTesting
  static class KeyPool extends com.minisdk.glide.load.engine.bitmap_recycle.BaseKeyPool<Key> {
  ...
  @VisibleForTesting
  static final class Key implements com.minisdk.glide.load.engine.bitmap_recycle.Poolable {
