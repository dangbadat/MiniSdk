...
import com.minisdk.glide.load.ImageHeaderParser.ImageType;
import com.minisdk.glide.load.ImageHeaderParserUtils;
...
import com.minisdk.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.minisdk.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link com.minisdk.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.minisdk.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * {@link com.minisdk.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   * <p>This option is ignored unless we're on Android O+.
   */
  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.minisdk.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
   ...
   * provided  {@link com.minisdk.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
