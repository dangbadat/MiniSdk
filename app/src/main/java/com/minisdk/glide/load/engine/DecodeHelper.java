...
import com.minisdk.glide.load.engine.DecodeJob.DiskCacheProvider;
...
import com.minisdk.glide.load.model.ModelLoader.LoadData;
import com.minisdk.glide.load.resource.UnitTransformation;
import java.io.File;
...
final class DecodeHelper<Transcode> {
  ...
  private com.minisdk.glide.load.engine.DecodeJob.DiskCacheProvider diskCacheProvider;
  ...
  boolean isResourceEncoderAvailable(com.minisdk.glide.load.engine.Resource<?> resource) {
