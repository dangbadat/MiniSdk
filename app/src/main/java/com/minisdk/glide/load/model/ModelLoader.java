 ...
 * {@link com.minisdk.glide.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {
  ...
  /**
   * Returns a {@link com.minisdk.glide.load.model.ModelLoader.LoadData} containing a
   ...
   *               {@link com.minisdk.glide.request.target.Target#SIZE_ORIGINAL} to indicate that
