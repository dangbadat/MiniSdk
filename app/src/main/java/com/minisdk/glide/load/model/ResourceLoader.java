 ...
 */
public class ResourceLoader<Data> implements com.minisdk.glide.load.model.ModelLoader<Integer, Data> {
  private static final String TAG = "ResourceLoader";
  private final com.minisdk.glide.load.model.ModelLoader<Uri, Data> uriLoader;
  private final Resources resources;

  // Public API.
  @SuppressWarnings("WeakerAccess")
  public ResourceLoader(Resources resources, com.minisdk.glide.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Integer, InputStream> {
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<Integer, InputStream> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static class FileDescriptorFactory
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<Integer, ParcelFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static final class AssetFileDescriptorFactory
    ...
    @Override
    public com.minisdk.glide.load.model.ModelLoader<Integer, AssetFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
