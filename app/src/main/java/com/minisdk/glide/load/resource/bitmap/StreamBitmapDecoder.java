...
import com.minisdk.glide.load.resource.bitmap.RecyclableBufferedInputStream;
import com.minisdk.glide.util.ExceptionCatchingInputStream;
import com.minisdk.glide.util.MarkEnforcingInputStream;
...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
  ...
  private final com.minisdk.glide.load.resource.bitmap.Downsampler downsampler;
  private final ArrayPool byteArrayPool;

  public StreamBitmapDecoder(com.minisdk.glide.load.resource.bitmap.Downsampler downsampler, ArrayPool byteArrayPool) {
