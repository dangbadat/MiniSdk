...
final class BitmapPreFillRunner implements Runnable {
  ...
  private final com.minisdk.glide.load.engine.prefill.PreFillQueue toPrefill;
  private final Clock clock;
  private final Set<com.minisdk.glide.load.engine.prefill.PreFillType> seenTypes = new HashSet<>();
  ...
  public BitmapPreFillRunner(
      BitmapPool bitmapPool, MemoryCache memoryCache, com.minisdk.glide.load.engine.prefill.PreFillQueue allocationOrder) {
    this(
        bitmapPool,
        memoryCache,
        allocationOrder,
  ...
  BitmapPreFillRunner(
      ...
      com.minisdk.glide.load.engine.prefill.PreFillQueue allocationOrder,
      Clock clock,
      Handler handler) {
