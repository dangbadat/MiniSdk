...
import com.minisdk.glide.disklrucache.DiskLruCache;
import com.minisdk.glide.disklrucache.DiskLruCache.Value;
import com.minisdk.glide.load.Key;
import com.minisdk.glide.load.engine.cache.DiskCache;
import com.minisdk.glide.load.engine.cache.DiskCacheWriteLocker;
import com.minisdk.glide.load.engine.cache.SafeKeyGenerator;
 ...
 * @see #get(File, long)
 */
public class DiskLruCacheWrapper implements com.minisdk.glide.load.engine.cache.DiskCache {
  ...
  private final com.minisdk.glide.load.engine.cache.SafeKeyGenerator safeKeyGenerator;
  ...
  @Deprecated
  public static synchronized com.minisdk.glide.load.engine.cache.DiskCache get(File directory, long maxSize) {
  ...
  protected DiskLruCacheWrapper(File directory, long maxSize) {
    ...
    this.safeKeyGenerator = new com.minisdk.glide.load.engine.cache.SafeKeyGenerator();
  }
