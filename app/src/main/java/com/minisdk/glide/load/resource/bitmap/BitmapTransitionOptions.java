...
import com.minisdk.glide.TransitionOptions;
import com.minisdk.glide.request.transition.BitmapTransitionFactory;
import com.minisdk.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see com.minisdk.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.minisdk.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
