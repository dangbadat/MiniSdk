...
import com.minisdk.glide.GlideContext;
import com.minisdk.glide.Priority;
import com.minisdk.glide.Registry;
...
import com.minisdk.glide.load.data.DataFetcher;
import com.minisdk.glide.load.data.DataRewinder;
...
import com.minisdk.glide.util.LogTime;
import com.minisdk.glide.util.Synthetic;
import com.minisdk.glide.util.pool.FactoryPools.Poolable;
import com.minisdk.glide.util.pool.GlideTrace;
import com.minisdk.glide.util.pool.StateVerifier;
...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback,
  ...
  private void notifyComplete(com.minisdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    setNotifiedOrThrow();
  ...
  private void decodeFromRetrievedData() {
    ...
    com.minisdk.glide.load.engine.Resource<R> resource = null;
    try {
  ...
  private void notifyEncodeAndRelease(com.minisdk.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    if (resource instanceof Initializable) {
      ((Initializable) resource).initialize();
    }

    com.minisdk.glide.load.engine.Resource<R> result = resource;
  ...
  private <Data> com.minisdk.glide.load.engine.Resource<R> decodeFromData(DataFetcher<?> fetcher, Data data,
    ...
    try {
      ...
      com.minisdk.glide.load.engine.Resource<R> result = decodeFromFetcher(data, dataSource);
      if (Log.isLoggable(TAG, Log.VERBOSE)) {
  ...
  private <Data> com.minisdk.glide.load.engine.Resource<R> decodeFromFetcher(Data data, DataSource dataSource)
  ...
  private <Data, ResourceType> com.minisdk.glide.load.engine.Resource<R> runLoadPath(Data data, DataSource dataSource,
  ...
  @Synthetic
  @NonNull
  <Z> com.minisdk.glide.load.engine.Resource<Z> onResourceDecoded(DataSource dataSource,
                                                                   @NonNull com.minisdk.glide.load.engine.Resource<Z> decoded) {
    @SuppressWarnings("unchecked")
    Class<Z> resourceSubClass = (Class<Z>) decoded.get().getClass();
    Transformation<Z> appliedTransformation = null;
    com.minisdk.glide.load.engine.Resource<Z> transformed = decoded;
    ...
    com.minisdk.glide.load.engine.Resource<Z> result = transformed;
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.engine.Resource<Z> onResourceDecoded(@NonNull com.minisdk.glide.load.engine.Resource<Z> decoded) {
