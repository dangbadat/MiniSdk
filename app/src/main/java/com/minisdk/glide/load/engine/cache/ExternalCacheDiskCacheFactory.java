...
import com.minisdk.glide.load.engine.cache.DiskLruCacheFactory;

import java.io.File;

/**
 * Creates an {@link com.minisdk.glide.disklrucache.DiskLruCache} based disk cache in the external
...
public final class ExternalCacheDiskCacheFactory extends DiskLruCacheFactory {
  ...
  public ExternalCacheDiskCacheFactory(Context context) {
    this(context, com.minisdk.glide.load.engine.cache.DiskCache.Factory.DEFAULT_DISK_CACHE_DIR,
        com.minisdk.glide.load.engine.cache.DiskCache.Factory.DEFAULT_DISK_CACHE_SIZE);
  }
