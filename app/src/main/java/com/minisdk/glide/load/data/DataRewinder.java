...
public interface DataRewinder<T> {
   ...
   * {@link com.minisdk.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.minisdk.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.minisdk.glide.load.data.DataRewinder} wrapping the given data.
     */
    @NonNull
     ...
     * {@link com.minisdk.glide.load.data.DataRewinder}s for.
     */
    @NonNull
