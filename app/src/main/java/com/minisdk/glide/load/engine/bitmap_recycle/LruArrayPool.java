...
public final class LruArrayPool implements ArrayPool {
  ...
  private static final class KeyPool extends com.minisdk.glide.load.engine.bitmap_recycle.BaseKeyPool<Key> {
  ...
  private static final class Key implements com.minisdk.glide.load.engine.bitmap_recycle.Poolable {
