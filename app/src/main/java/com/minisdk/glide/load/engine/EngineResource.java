 ...
 * com.minisdk.glide.load.engine.Resource} interface.
 *
 * @param <Z> The type of data returned by the wrapped {@link com.minisdk.glide.load.engine.Resource}.
 */
class EngineResource<Z> implements com.minisdk.glide.load.engine.Resource<Z> {
  private final boolean isMemoryCacheable;
  private final boolean isRecyclable;
  private final com.minisdk.glide.load.engine.Resource<Z> resource;
  ...
  EngineResource(
      com.minisdk.glide.load.engine.Resource<Z> toWrap,
