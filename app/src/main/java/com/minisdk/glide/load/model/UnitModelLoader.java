 ...
 */
public class UnitModelLoader<Model> implements com.minisdk.glide.load.model.ModelLoader<Model, Model> {
  ...
  /**
   * Factory for producing {@link com.minisdk.glide.load.model.UnitModelLoader}s.
   *
   * @param <Model> The type of model that will also be returned as decodable data.
   */
