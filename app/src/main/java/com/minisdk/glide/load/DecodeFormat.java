 ...
 * {@link android.graphics.Bitmap}s returned by {@link com.minisdk.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.minisdk.glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.minisdk.glide.load.ResourceDecoder}.
   ...
   * request, use {@link com.minisdk.glide.request.RequestOptions#disallowHardwareConfig()}.
   *
