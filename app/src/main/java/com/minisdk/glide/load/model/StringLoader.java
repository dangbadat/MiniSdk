 ...
 */
public class StringLoader<Data> implements com.minisdk.glide.load.model.ModelLoader<String, Data> {
  private final com.minisdk.glide.load.model.ModelLoader<Uri, Data> uriLoader;

  // Public API.
  @SuppressWarnings("WeakerAccess")
  public StringLoader(com.minisdk.glide.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements ModelLoaderFactory<String, InputStream> {
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<String, InputStream> build(
  ...
  public static class FileDescriptorFactory
    ...
    @NonNull
    @Override
    public com.minisdk.glide.load.model.ModelLoader<String, ParcelFileDescriptor> build(
        @NonNull MultiModelLoaderFactory multiFactory) {
