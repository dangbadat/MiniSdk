 ...
 * {@link com.minisdk.glide.GlideBuilder} and registering
 * {@link com.minisdk.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.minisdk.glide.load.ResourceDecoder)} for each
 * {@link com.minisdk.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.minisdk.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.minisdk.glide.samples.flickr.FlickrGlideModule"
