...
import com.minisdk.glide.request.transition.NoTransition;
import com.minisdk.glide.request.transition.TransitionFactory;
import com.minisdk.glide.request.transition.ViewAnimationFactory;
import com.minisdk.glide.request.transition.ViewPropertyAnimationFactory;
import com.minisdk.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link com.minisdk.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link com.minisdk.glide.request.transition.Transition} for each request started with these
