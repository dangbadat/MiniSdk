...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * {@link com.minisdk.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link com.minisdk.glide.ListPreloader} that accepts interfaces for providing
