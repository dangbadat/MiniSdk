...
import com.minisdk.glide.load.Encoder;
...
import com.minisdk.glide.load.data.DataRewinderRegistry;
import com.minisdk.glide.load.engine.DecodePath;
import com.minisdk.glide.load.engine.LoadPath;
...
import com.minisdk.glide.load.model.ModelLoaderRegistry;
import com.minisdk.glide.load.resource.transcode.ResourceTranscoder;
import com.minisdk.glide.load.resource.transcode.TranscoderRegistry;
import com.minisdk.glide.provider.EncoderRegistry;
import com.minisdk.glide.provider.ImageHeaderParserRegistry;
import com.minisdk.glide.provider.LoadPathCache;
import com.minisdk.glide.provider.ModelToResourceClassCache;
import com.minisdk.glide.provider.ResourceDecoderRegistry;
import com.minisdk.glide.provider.ResourceEncoderRegistry;
import com.minisdk.glide.util.pool.FactoryPools;
...
public class Registry {
   ...
   * {@link com.minisdk.glide.load.resource.gif.GifDrawable} etc).
   ...
   * {@link com.minisdk.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.minisdk.glide.load.data.DataRewinder.Factory} to handle a
