...
import com.minisdk.glide.load.DecodeFormat;
import com.minisdk.glide.load.ImageHeaderParser;
import com.minisdk.glide.load.ResourceDecoder;
import com.minisdk.glide.load.data.InputStreamRewinder;
import com.minisdk.glide.load.engine.Engine;
import com.minisdk.glide.load.engine.bitmap_recycle.ArrayPool;
import com.minisdk.glide.load.engine.bitmap_recycle.BitmapPool;
import com.minisdk.glide.load.engine.cache.MemoryCache;
import com.minisdk.glide.load.engine.prefill.BitmapPreFiller;
import com.minisdk.glide.load.engine.prefill.PreFillType;
import com.minisdk.glide.load.model.AssetUriLoader;
import com.minisdk.glide.load.model.ByteArrayLoader;
import com.minisdk.glide.load.model.ByteBufferEncoder;
import com.minisdk.glide.load.model.ByteBufferFileLoader;
import com.minisdk.glide.load.model.DataUrlLoader;
import com.minisdk.glide.load.model.FileLoader;
import com.minisdk.glide.load.model.GlideUrl;
import com.minisdk.glide.load.model.MediaStoreFileLoader;
import com.minisdk.glide.load.model.ResourceLoader;
import com.minisdk.glide.load.model.StreamEncoder;
import com.minisdk.glide.load.model.StringLoader;
import com.minisdk.glide.load.model.UnitModelLoader;
import com.minisdk.glide.load.model.UriLoader;
import com.minisdk.glide.load.model.UrlUriLoader;
import com.minisdk.glide.load.model.stream.HttpGlideUrlLoader;
import com.minisdk.glide.load.model.stream.HttpUriLoader;
import com.minisdk.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.minisdk.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.minisdk.glide.load.model.stream.UrlLoader;
import com.minisdk.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.minisdk.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.minisdk.glide.load.resource.bitmap.BitmapEncoder;
import com.minisdk.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.minisdk.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.minisdk.glide.load.resource.bitmap.Downsampler;
import com.minisdk.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.minisdk.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.minisdk.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.minisdk.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.minisdk.glide.load.resource.bitmap.VideoDecoder;
import com.minisdk.glide.load.resource.bytes.ByteBufferRewinder;
import com.minisdk.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.minisdk.glide.load.resource.drawable.UnitDrawableDecoder;
import com.minisdk.glide.load.resource.file.FileDecoder;
import com.minisdk.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.minisdk.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.minisdk.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.minisdk.glide.manager.ConnectivityMonitorFactory;
import com.minisdk.glide.manager.RequestManagerRetriever;
import com.minisdk.glide.module.ManifestParser;
import com.minisdk.glide.request.RequestListener;
import com.minisdk.glide.request.RequestOptions;
import com.minisdk.glide.request.target.ImageViewTargetFactory;
import com.minisdk.glide.request.target.Target;
import com.minisdk.glide.util.Preconditions;
import com.minisdk.glide.util.Util;
 ...
 * {@link com.minisdk.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
    ...
    private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
        ...
        List<com.minisdk.glide.module.GlideModule> manifestModules = Collections.emptyList();
        ...
        if (annotationGeneratedModule != null
            ...
            Iterator<com.minisdk.glide.module.GlideModule> iterator = manifestModules.iterator();
            while (iterator.hasNext()) {
                com.minisdk.glide.module.GlideModule current = iterator.next();
        ...
        if (Log.isLoggable(TAG, Log.DEBUG)) {
            for (com.minisdk.glide.module.GlideModule glideModule : manifestModules) {
        ...
        for (com.minisdk.glide.module.GlideModule module : manifestModules) {
        ...
        try {
            Class<GeneratedAppGlideModule> clazz =
                    (Class<GeneratedAppGlideModule>)
                            Class.forName("com.minisdk.glide.GeneratedAppGlideModuleImpl");
     ...
     * {@link com.minisdk.glide.load.Transformation}s. Use outside of these classes is not generally
     * recommended. </p>
     */
    @NonNull
