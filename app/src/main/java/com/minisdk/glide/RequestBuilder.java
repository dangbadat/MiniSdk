...
import static com.minisdk.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.minisdk.glide.request.RequestOptions.signatureOf;
import static com.minisdk.glide.request.RequestOptions.skipMemoryCacheOf;
...
import com.minisdk.glide.Priority;
import com.minisdk.glide.RequestManager;
import com.minisdk.glide.load.Transformation;
import com.minisdk.glide.load.engine.DiskCacheStrategy;
import com.minisdk.glide.request.BaseRequestOptions;
import com.minisdk.glide.request.ErrorRequestCoordinator;
import com.minisdk.glide.request.FutureTarget;
import com.minisdk.glide.request.Request;
import com.minisdk.glide.request.RequestCoordinator;
import com.minisdk.glide.request.RequestFutureTarget;
import com.minisdk.glide.request.RequestListener;
import com.minisdk.glide.request.RequestOptions;
import com.minisdk.glide.request.SingleRequest;
import com.minisdk.glide.request.ThumbnailRequestCoordinator;
import com.minisdk.glide.request.target.PreloadTarget;
import com.minisdk.glide.request.target.Target;
import com.minisdk.glide.request.target.ViewTarget;
import com.minisdk.glide.signature.ApplicationVersionSignature;
import com.minisdk.glide.util.Executors;
import com.minisdk.glide.util.Preconditions;
import com.minisdk.glide.util.Synthetic;
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
  ...
  protected static final RequestOptions DOWNLOAD_ONLY_OPTIONS =
      new RequestOptions().diskCacheStrategy(DiskCacheStrategy.DATA).priority(com.minisdk.glide.Priority.LOW)
          .skipMemoryCache(true);

  private final Context context;
  private final RequestManager requestManager;
  private final Class<TranscodeType> transcodeClass;
  private final com.minisdk.glide.Glide glide;
   ...
   * com.minisdk.glide.load.model.ModelLoader}, {@link com.minisdk.glide.load.ResourceDecoder},
   * and {@link Transformation}s. However,
   * {@link com.minisdk.glide.request.RequestOptions#placeholder(int)} and
   * {@link com.minisdk.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link com.minisdk.glide.load.model.ModelLoader} or
   * {@link com.minisdk.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link com.minisdk.glide.request.RequestOptions#signature(com.minisdk.glide.load.Key)} to
   ...
   * {@link com.minisdk.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link com.minisdk.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link com.minisdk.glide.request.RequestOptions#signature(com.minisdk.glide.load.Key)}
   ...
   * {@link com.minisdk.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.minisdk.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * transformed (other than {@link com.minisdk.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   *               overridden by
   *               {@link com.minisdk.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see com.minisdk.glide.ListPreloader
   */
  @NonNull
  ...
  @NonNull
  private com.minisdk.glide.Priority getThumbnailPriority(@NonNull com.minisdk.glide.Priority current) {
    switch (current) {
      case LOW:
        return com.minisdk.glide.Priority.NORMAL;
      case NORMAL:
        return com.minisdk.glide.Priority.HIGH;
      case HIGH:
      case IMMEDIATE:
        return com.minisdk.glide.Priority.IMMEDIATE;
      default:
  ...
  private Request buildRequestRecursive(
      ...
      com.minisdk.glide.Priority priority,
      int overrideWidth,
      int overrideHeight,
      BaseRequestOptions<?> requestOptions,
      Executor callbackExecutor) {
  ...
  private Request buildThumbnailRequestRecursive(
    ...
    if (thumbnailBuilder != null) {
      ...
      com.minisdk.glide.Priority thumbPriority = thumbnailBuilder.isPrioritySet()
