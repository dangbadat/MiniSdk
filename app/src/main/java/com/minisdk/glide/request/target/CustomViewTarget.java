...
/**
 * A base {@link com.minisdk.glide.request.target.Target} for loading resources ({@link android.graphics.Bitmap}, {@link Drawable}
 ...
 */
public abstract class CustomViewTarget<T extends View, Z> implements com.minisdk.glide.request.target.Target<Z> {
