package com.minisdk.glide.request.target;

import android.graphics.drawable.Drawable;
import android.support.annotation.NonNull;
import android.view.View;

import com.minisdk.glide.request.target.BaseTarget;
import com.minisdk.glide.request.target.SizeReadyCallback;
...
/**
 * A simple {@link com.minisdk.glide.request.target.Target} base class with default (usually no-op)
 ...
 * resort. {@link com.minisdk.glide.request.target.ViewTarget} or a subclass of {@link com.minisdk.glide.request.target.ViewTarget} is almost always a better choice.
 *
 * <p><em>Don't forget to clear instances of this class!</em>. If you must use this class, keep in
 * mind that unlike {@link com.minisdk.glide.request.target.ViewTarget} it is not safe to load into new instances of this class
 ...
 * to the previous instance and either call {@link com.minisdk.glide.RequestManager#clear(com.minisdk.glide.request.target.Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link com.minisdk.glide.RequestBuilder#into(com.minisdk.glide.request.target.Target)} method returns the {@link
 * com.minisdk.glide.request.target.Target} instance you provided to make retaining a reference to the {@link com.minisdk.glide.request.target.Target} as easy as
 * possible. That said, you must wait until you're completely finished with the resource before
 * calling {@link com.minisdk.glide.RequestManager#clear(com.minisdk.glide.request.target.Target)} and you should always null out
 * references to any loaded resources in {@link com.minisdk.glide.request.target.Target#onLoadCleared(Drawable)}.
 *
 * <p>Always try to provide a size when using this class. Use {@link SimpleTarget#SimpleTarget(int,
 * int)} whenever possible with values that are <em>not</em> {@link com.minisdk.glide.request.target.Target#SIZE_ORIGINAL}. Using
 * {@link com.minisdk.glide.request.target.Target#SIZE_ORIGINAL} is unsafe if you're loading large images or are running your
 ...
 * if you use {@link com.minisdk.glide.request.target.ViewTarget} so prefer {@link ViewTarget} over this class whenver possible.
 *
