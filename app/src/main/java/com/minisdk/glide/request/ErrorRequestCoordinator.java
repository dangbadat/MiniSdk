...
/**
 * Runs a single primary {@link com.minisdk.glide.request.Request} until it completes and then a fallback error request only
 * if the single primary request fails.
 */
public final class ErrorRequestCoordinator implements com.minisdk.glide.request.RequestCoordinator,
        com.minisdk.glide.request.Request {

  @Nullable
  private final com.minisdk.glide.request.RequestCoordinator parent;
  private com.minisdk.glide.request.Request primary;
  private com.minisdk.glide.request.Request error;

  public ErrorRequestCoordinator(@Nullable RequestCoordinator parent) {
    this.parent = parent;
  }

  public void setRequests(com.minisdk.glide.request.Request primary, com.minisdk.glide.request.Request error) {
  ...
  @Override
  public boolean isEquivalentTo(com.minisdk.glide.request.Request o) {
  ...
  @Override
  public boolean canSetImage(com.minisdk.glide.request.Request request) {
  ...
  @Override
  public boolean canNotifyStatusChanged(com.minisdk.glide.request.Request request) {
    return parentCanNotifyStatusChanged() && isValidRequest(request);
  }

  @Override
  public boolean canNotifyCleared(com.minisdk.glide.request.Request request) {
  ...
  private boolean isValidRequest(com.minisdk.glide.request.Request request) {
  ...
  @Override
  public void onRequestSuccess(com.minisdk.glide.request.Request request) {
    if (parent != null) {
