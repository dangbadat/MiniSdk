...
/**
 * A coordinator that coordinates two individual {@link com.minisdk.glide.request.Request}s that load a small thumbnail
 * version of an image and the full size version of the image at the same time.
 */
public class ThumbnailRequestCoordinator implements com.minisdk.glide.request.RequestCoordinator,
        com.minisdk.glide.request.Request {
  @Nullable private final com.minisdk.glide.request.RequestCoordinator parent;

  private com.minisdk.glide.request.Request full;
  private com.minisdk.glide.request.Request thumb;
  ...
  public void setRequests(com.minisdk.glide.request.Request full, com.minisdk.glide.request.Request thumb) {
    this.full = full;
    this.thumb = thumb;
  }
  ...
  @Override
  public void onRequestFailed(com.minisdk.glide.request.Request request) {
