...
/**
 * A request that loads a resource for an {@link com.minisdk.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link com.minisdk.glide.request.target.Target}s (for example). Using a similar but different
