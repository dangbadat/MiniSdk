...
import com.minisdk.glide.RequestBuilder;
...
public interface RequestListener<R> {
   ...
   * use {@link com.minisdk.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.minisdk.glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
