...
import com.minisdk.glide.request.target.ImageViewTarget;
...
/**
 * A base {@link com.minisdk.glide.request.target.Target} for loading resources ({@link Bitmap}, {@link Drawable}
 * etc) that are used outside of {@link View}s.
 *
 * <p>If you're loading a resource into a {@link View}, use
 * {@link com.minisdk.glide.RequestBuilder#into(ImageView)}, a subclass of {@link ImageViewTarget},
 ...
 * manually clear this {@link com.minisdk.glide.request.target.Target}, Glide may do so automatically after certain lifecycle events
 * in {@link android.support.v4.app.Fragment}s and {@link android.app.Activity}s.
 *
 * <p>This class can only be used with {@link com.minisdk.glide.request.target.Target#SIZE_ORIGINAL} or when the desired resource
 * dimensions are known when the {@link com.minisdk.glide.request.target.Target} is created. If you'd like to run some asynchronous
 * process and make full use of {@link #getSize(SizeReadyCallback)} and {@link SizeReadyCallback},
 * extend {@link com.minisdk.glide.request.target.Target} directly instead of using this class.
 *
 * @param <T> The type of resource that will be loaded (e.g. {@link Bitmap}).
 */
public abstract class CustomTarget<T> implements com.minisdk.glide.request.target.Target<T> {
   ...
   * {@link com.minisdk.glide.request.RequestOptions#override(int)}. In all other cases, prefer
   * {@link #CustomTarget(int, int)}.
   */
  public CustomTarget() {
    this(com.minisdk.glide.request.target.Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL);
  }
   ...
   * {@link com.minisdk.glide.request.RequestOptions#override(int)} in the request).
   *
