...
import com.minisdk.glide.load.MultiTransformation;
import com.minisdk.glide.load.Option;
...
import com.minisdk.glide.load.resource.bitmap.CenterCrop;
import com.minisdk.glide.load.resource.bitmap.CenterInside;
import com.minisdk.glide.load.resource.bitmap.CircleCrop;
import com.minisdk.glide.load.resource.bitmap.DownsampleStrategy;
import com.minisdk.glide.load.resource.bitmap.Downsampler;
import com.minisdk.glide.load.resource.bitmap.DrawableTransformation;
import com.minisdk.glide.load.resource.bitmap.FitCenter;
import com.minisdk.glide.load.resource.bitmap.VideoDecoder;
import com.minisdk.glide.signature.EmptySignature;
import com.minisdk.glide.util.CachedHashCodeArrayMap;
 ...
 * {@link com.minisdk.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.minisdk.glide.request.target.Target}'s size before
   ...
   *                       {@link com.minisdk.glide.request.target.Target}'s dimensions when
   ...
   * {@link com.minisdk.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.minisdk.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.minisdk.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link com.minisdk.glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use
   ...
   * {@link com.minisdk.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other
   * networking library including Glide's Volley or OkHttp integration libraries, this option will
   * be ignored.
   *
   * @see com.minisdk.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.minisdk.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * {@link com.minisdk.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
//  @NonNull
