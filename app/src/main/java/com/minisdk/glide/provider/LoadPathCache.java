package com.minisdk.glide.provider;
...
import com.minisdk.glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link com.minisdk.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
